...
<p align="center">Software Engineering student at FPT University<br/>Building backend systems, interactive web apps, and optimization projects.</p>
...
`Java` · `Python` · `TypeScript` · `C++` · `React` · `NestJS` · `PostgreSQL` · `CUDA`
